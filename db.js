    ...
    if(req.oldfP!=fP){
        ...
        function keywordFormat(KW_ID_weight,formatted,callback){
            ...
            connection.query("select keyword from keyword_table where keyword_id="+KW.keyword_id,(e, keyword, f)=>{
                formatted[formatted.length] = {"keyword":keyword[0]['keyword'], "keyword_weight":KW.keyword_weight};
...
module.exports.editResearch = function(req, editor, fP, extraFilePaths, callback){
    ...
    connection.query("select filePath, hidden from research_table where research_id = "+ escapeRS(req.research_id)+";", (e, r, f)=>{
        ...
        db.addResearch(req, editor, (fP == "" ? req.oldfP : fP), extraFilePaths+keepedExtraFiles, (res)=>{
